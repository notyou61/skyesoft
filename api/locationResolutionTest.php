...
<style>
    ...
    .result { margin-top: 25px; padding: 20px; border: 1px solid #ddd; background: #f9f9f9; border-radius: 8px; }
...
<form method="post">
    <input type="text" name="address" value="<?php echo htmlspecialchars($rawAddress); ?>" 
           placeholder="225 N 1ST ST BUCKEYE AZ 85326" style="width:650px;">
...
<div class="result">
    ...
    $jsonOutput = [
        ...
        'google' => ['placeId' => $placeId ?: null, 'latitude' => $latitude ?: null, 'longitude' => $longitude ?: null],
        'census' => $censusResult,
        'parcel' => $parcelResult,
        'jurisdiction' => [
        ...
        'governance' => ['rsCode' => $rsCode, 'parcelStatus' => $parcelStatus]
    ];
    ?>
