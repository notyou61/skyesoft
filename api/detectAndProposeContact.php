...
// -------------------------------------------------
// IMPROVED STATIC FALLBACK NARRATIVES
// -------------------------------------------------
$pcmNarratives = [
    'new_elc' => [
        'decision' => [
            'The proposal is operationally eligible for insertion as a new entity, location, and contact relationship.'
        ],
        'informational' => [
    ...
    'invalid_location' => [
        'decision' => [
            'The proposed address could not be validated.'
        ],
        'blocking' => [
    ...
    'incomplete_address' => [
        'decision' => [
            'The proposal contains an incomplete or overly vague address.'
        ],
        'blocking' => [
            'A specific street address is required before this proposal can proceed.'
        ],
        'review' => [
            'The operator should provide a complete street address for the location.'
        ]
    ],
...
// -------------------------------------------------
$aiNarrativeContext = [ /* your existing context */ ];
