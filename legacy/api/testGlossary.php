...
// Load codex (correct path to /docs/codex/codex.json)
$codexPath = __DIR__ . '/../docs/codex/codex.json';
if (!file_exists($codexPath)) {
    die("❌ Codex file not found at: $codexPath\n");
}
...
$outputPath = __DIR__ . '/../docs/sheets/Glossary-Test.pdf';
$pdf->Output($outputPath, 'F');
echo "✅ Glossary-Test.pdf created at: $outputPath\n";
