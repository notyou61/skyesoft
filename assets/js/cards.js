/* ============================================================
   #region CARD DEFINITIONS — Legacy Restored
============================================================ */
const cards = [
  {
...

  {
    ...
    body: `
      <div class="entry">📅 <span id="todaysDate"></span> · 
        Day <span id="dayOfYear"></span> of 365 
        (<span id="daysRemaining"></span> remaining)
      </div>
      <div class="entry">🌄 Sunrise: <span id="sunriseTime">--</span> 
        · 🌇 Sunset: <span id="sunsetTime">--</span></div>
      <div class="entry">🕒 Daylight: <span id="daylightTime">--</span> 
        · 🌌 Night: <span id="nightTime">--</span></div>
