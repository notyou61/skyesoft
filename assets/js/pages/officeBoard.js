...
const BOARD_CARDS = [
  {
    id: "todaysHighlights",
    durationMs: 30000,
    header: { icon: "🌅", title: "Today’s Highlights" },
    body: `
      <div class="entry">📅 Today’s date goes here</div>
  ...
  },
  {
    id: "kpiDashboard",
    durationMs: 30000,
    header: { icon: "📈", title: "KPI Dashboard" },
    body: `
      <div class="entry">🚧 KPI dashboard coming soon.</div>
    `,
  ...
  },
  {
    id: "announcements",
    durationMs: 30000,
    header: { icon: "📢", title: "Announcements" },
    body: `
      <div class="entry">No announcements posted.</div>
    `,
  ...
  host.innerHTML = `
    <div class="boardCard">
      ...
      <div class="cardHeader">
        <span class="cardIcon">${card.header.icon}</span>
        <span class="cardTitle">${card.header.title}</span>
      </div>
...
// #region CARD ROTATION (TEMP)

let currentCardIndex = 0;
let rotationTimer = null;

function showNextCard() {
  const card = BOARD_CARDS[currentCardIndex];
  renderCard(card);

  currentCardIndex = (currentCardIndex + 1) % BOARD_CARDS.length;

  rotationTimer = setTimeout(showNextCard, card.durationMs);
}
